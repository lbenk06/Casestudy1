...
class Device(Serializable):
    ...
    def __init__(self, id: str, managed_by_user_id: str, status:str, end_of_life: datetime = None, creation_date: datetime = None, last_update: datetime = None):
    ...
    def instantiate_from_dict(cls, data: dict) -> Self:
        return cls(data['id'], data['managed_by_user_id'],data.get('status', 'available'), data['end_of_life'], data['creation_date'], data['last_update'])
